...
The method applies to cross-couplings of monosubstituted alkenes with aryl/vinyl halides (Cl, Br, or I) or triflates in the presence of a base and a palladium (Pd) catalyst with monodentate triphenylphosphine ($`PPh_3`$) ligands to form branched (𝛂) and/or linear (𝛃) disubstituted alkenes.
